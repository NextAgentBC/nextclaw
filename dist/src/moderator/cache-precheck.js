 ...
 */
import { lookupCachedAnswerExact, lookupCachedAnswerSemantic, recordCacheHit, } from "../cache/qa.js";
const L0_CAP = 200;
const L0_TTL_MS = 5 * 60 * 1000; // 5 minutes
const L0 = new Map(); // scope-aware Map<key, L0Entry>
function l0Key(scopeKey, questionTextNormalized, viewerUserId) {
...
export function clearL0Cache() {
    L0.clear();
}
export function l0Stats() {
 ...
 */
export async function tryCachePrecheck(deps, params) {
