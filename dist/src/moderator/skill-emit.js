 ...
 */
function buildSkillMarkdown(params, safeKey) {
 ...
 */
export async function emitRoleAsSkill(params) {
    ...
    try {
        ...
        params.logger?.info?.(`skill-emit: wrote ${skillFile} (${content.length} bytes, role=${safeKey})`);
 ...
 */
export function defaultSkillEmitDir() {
